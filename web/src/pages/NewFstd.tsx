...
/**
 * Records a simulator (FSTD) session. The device is picked by autocomplete on
 * its EASA code or serial number; a device that is not listed can be added. The
 * session carries no flight time - the device, the pilot's function and the
 * session duration are what matter.
 */
...
export function NewFstd() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      <h1 className="text-xl font-semibold">New simulator session</h1>
      <Card>
